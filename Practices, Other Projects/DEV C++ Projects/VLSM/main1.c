...
main(){
	int octet1, octet2, octet3, octet4, mask, hosts[50], networks, i, totalhosts = 0, hostsavailable, hostsallocated, broadcast1, broadcast2, broadcast3, broadcast4;
	double bb;
	...
	for(i = 0; i < networks; i++){
		...
		printf("\n%d\t%d\t%d.%d.%d.%d\t/%d\t", i + 1, hosts[i], octet1, octet2, octet3, octet4, 32 - bb);

...
public class NumberConversion {
	...
	public String getBinaryToHexEquivalent() {
		String hex = "";
		this.setNum(getDecimalEquivalent());
		hex = this.getHexEquivalent();
		return hex;
	}

	public static void main(String[] args) {

		NumberConversion myClass = new NumberConversion();
		int decimal = 0;
		String binary = "";
		char c;
		...
		case 'b':
			...
			case 'b':
				System.out.println("Octal Equivalent is "
						+ myClass.getBinaryToHexEquivalent());
			}
		}
	}
}